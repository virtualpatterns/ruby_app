...
add_step! (RubyApp::Elements::Mobile::Page::ShownEvent) { |event| event.assert_exists_input('Search') }
add_step! (RubyApp::Element::AssertedEvent)             { |event| event.update_input('Search', 'value') }
